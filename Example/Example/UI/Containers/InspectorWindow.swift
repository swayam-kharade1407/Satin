...
public final class InspectorWindow: NSWindow {
    public var inspectorViewController: InspectorViewController?

    public init(_ title: String = "") {
        super.init(
            contentRect: NSMakeRect(500, 500, 240, 240),
...
public final class InspectorWindow: UIViewController {
    public enum Edge {
        case left
        case right
    }
    ...
    func updatePosition(_ animated: Bool = true) {
        guard let topAnchorConstraint = topAnchorConstraint,
              ...
              let buttonAnchorConstraint = buttonAnchorConstraint,
    ...
    func setupGestures() {
        ...
        viewTapGestureRegognizer = tapGestureRegognizer
    }
