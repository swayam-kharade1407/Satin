...
protocol ParameterGroupHeaderViewControllerDelegate: AnyObject {
    func onOpen(header: ParameterGroupHeaderViewController)
    func onClose(header: ParameterGroupHeaderViewController)
}

final class ParameterGroupHeaderViewController: UIViewController {
    public weak var delegate: ParameterGroupHeaderViewControllerDelegate?
    ...
    func setupView() {
        view = UIView()
        view.backgroundColor = UIColor(named: "PanelHeader", in: Bundle(for: ParameterGroupHeaderViewController.self), compatibleWith: nil)
